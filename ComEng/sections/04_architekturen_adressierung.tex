...
\begin{itemize}
    \item \textbf{Multiple:} \texttt{LDM R7!, \{R0-R3, R5\}} -> Lädt mehrere Register beginnend bei der Adresse in $R7$.
    \item \textbf{Stack:} \texttt{PUSH \{R0-R2\}}, \texttt{POP \{R0-R2\}}.
    \item \textbf{Goldene Regel:} Das Register mit der niedrigsten Nummer (\texttt{R0}) geht immer in die niedrigste Speicheradresse.
    Die Reihenfolge in den geschweiften Klammern ist für die Hardware nicht relevant.
\end{itemize}
