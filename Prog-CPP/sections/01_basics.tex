...
Ein Stream repräsentiert einen generischen sequentiellen Datenstrom. 
Z.b: ein Eingabefeld, Dateien oder Netzwerktraffic.\\
...
\begin{itemize}
    ...
    \item Für jede Unit (Modul) sollte ein Namespace definiert werden
    \item \cor{Mit kleine Buchstaben starten}
    \item Namenlose Namespaces: vermeiden \texttt{static} für lokale Variablen
    \item Der \texttt{::}-Operator gibt immer die globalste Variable/Fkt. zurück
\end{itemize}
...
\begin{itemize}
    ...
    \item \texttt{enum} nur benutzen, falls die $+1$-Automatik nützlich ist
\end{itemize}
...
\begin{center}
    \begin{tabular}{ll}
    \toprule
    \textbf{Bereich} & \textbf{Empfohlene Syntax} \\
    \midrule
