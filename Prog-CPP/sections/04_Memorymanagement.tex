...
\begin{minipage}{0.5\columnwidth}
  \lstinputlisting[language=C++]{code/memory_leaks.cpp}
\end{minipage}
\begin{minipage}{0.5\columnwidth}
...
Eine Funktion / Klasse kann als Template definiert werden indem \verb|template<typename1 T1, typename2 T2, ...>| (mit\texttt{$<>$}) vor die Funktion / Klasse geschrieben wird. 
