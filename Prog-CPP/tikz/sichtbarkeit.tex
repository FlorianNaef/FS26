\begin{tikzpicture}[
    ...
    % Headers
    \node[header] (h1) {Vererbung};
    \node[header, right=2pt of h1] (h2) {In Basisklasse};
    \node[header, right=2pt of h2] (h3) {In abgeleiteter Klasse};

    % Zyklus für 3 Zeilen (public, protected, private)
    \foreach \r/\label/\style in {1/{\Large \textbf{public (normaler Fall)}}/row1, 2/{\Large \textbf{protected}}/row2, 3/{\Large \textbf{private}}/row1} {
