\section{Objektorientierte Programmierung (OOP)}
\label{sec:oop}
...
\subsection{Klassendefinition und Instanziierung}
...
\subsection{Attribute und Zustandsintegrität}
...
\subsubsection{Klassen- vs. Instanzvariablen}
\begin{itemize}
...
\subsubsection{Initialisierung und dynamische Attribute}
...
\subsection{Methoden-Attribute und self}
...
\subsection{Datenabstraktion und Kapselung}
...
\section{Magic Methods und benutzerdefiniertes Verhalten}
...
\subsection{Emulation von Container-Typen}
...
\subsection{Reflektierte Arithmetik-Methoden ('r'-Präfix)}
