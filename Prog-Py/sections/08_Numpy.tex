...
\begin{itemize}
    \item \textbf{Speed}: Verwendet optimierten C-Code und ersetzt langsame Standard-Python \texttt{for}-Schleifen.
    \item \textbf{Vectorization}: Arraybasierte Operationen werden automatisch elementweise ausgeführt.
...
In \texttt{arange} ist es möglich, einen negativen \texttt{step} anzugeben, um ein absteigendes Array zu erzeugen.
