...
\subsection{Häufige Methoden und Formatierungsargumente}
...
\begin{itemize}
    \item \textbf{Abbildung und Layout (\texttt{plt.subplots}, \texttt{plt.figure}):}
    \begin{itemize}
    ...
    \item \textbf{Text und Beschriftungen (\texttt{ax.set\_title}, \texttt{ax.set\_xlabel}, \texttt{ax.text}):}
    \begin{itemize}
...
\subsection{Subplots und Layouts}
...
\subsection{Bibliotheksvergleich}
\begin{itemize}
