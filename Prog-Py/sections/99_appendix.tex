\section{Anhang}\subsection{Type Conversion: \texttt{dict()} and \texttt{list()}}
\begin{itemize}
...
\subsection{Skriptausführung}To distinguish between a script being run directly and a script being imported as a module, Python uses the \texttt{\_\_name\_\_} variable.
...
\subsection{Zufallsverteilungen in NumPy}
\begin{itemize}
...
\subsection{Indexing vs. Slicing: Faustregel}
...
\subsubsection{Praxisbeispiel}Dato un array 2D di shape \texttt{(3, 3)}:
\begin{itemize}
