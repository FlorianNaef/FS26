...
\textbf{LIATE} - Priorität für $g$ (abzuleitende Funktion):
% \begin{enumerate}
...
\textbf{\color{orange}Konstante $+C_{1,2, \dots}$ aufteilen gemäss $\mathbb{D}$ der Originalfunktion $\left(\int f\diff x\right)$.}\\
...
\begin{center}
    ...
    \begin{tabular}{|l|l|}
        \hline
        % Erster Teil: Einzeilige Formeln (mit multicolumn)
        ...
        \hline
        % Zweiter Teil: Potenzen (zwei Spalten)
        ...
        \hline
        % Dritter Teil: Halber Winkel (zwei Spalten)
