...
\begin{minipage}{0.45\linewidth}
	\begin{itemize}
		...
		\item Die Anzahl der \textit{Knoten} (Schnittpunkte mit $x$-Achse) von $\Psi$ zeigt das Energieniveau an (+ Knoten $= + E$)
...
\begin{itemize}
	\item Dazwischen liegt Bandlücke $\rightarrow$ Fermi-Fläche $E_g$ (freie Stadionplätze)
...
wie viele Zustände im Band für einen Energiebereich existieren (für die mittleren Energieniveaus existieren mehrere $\Psi$-Lösungen mit derselben Knotenanzahl). (Im Bild N=8 atomi)
...
Beschreibt die Wahrscheinlichkeit, Elektronen auf einem bestimmten Energieniveau zu finden\medskip
...
\begin{minipage}[t]{0.5\linewidth}
	\textbf{Quantenphysik} (pauli prinzip)
