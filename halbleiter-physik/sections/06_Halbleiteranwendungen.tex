...
Il Fill Factor misura quanto la reale caratteristica corrente-tensione assomigli a un rettangolo ideale. Esso è il rapporto tra la potenza massima effettivamente erogabile e la potenza massima teorica (prodotto tra la tensione a vuoto $V_{oc}$ e la corrente di cortocircuito $I_{sc}$).