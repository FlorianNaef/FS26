...
Der Fill Factor misst, wie sehr die reale Strom-Spannungs-Kennlinie einem idealen Rechteck ähnelt. Er ist das Verhältnis der tatsächlich maximal abgebbaren Leistung zur theoretischen Maximalleistung (Produkt aus Leerlaufspannung $V_{oc}$ und Kurzschlussstrom $I_{sc}$).