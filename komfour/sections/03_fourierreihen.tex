...
\crd{\textbf{T-periodisch}: Endliche Anzahl Sprungstellen, $g- \in \infty$ und $g+ \in \infty$}
...
\begin{itemize}
    ...
    \item \cor{Achtung auf Edge-Cases mit $n$ im Nenner! (spezifisches $n$ separat mit Basisformel berechnen)}
    \item \textbf{Abschnittsweise Integration:} Intervall [0,T] in Teilintervalle aufteilen, falls sich der analytische Ausdruck von $f(t)$ ändert.
\end{itemize}
...
\begin{tabular}{l|l|l}
    \textbf{Eigenschaft}             & \multicolumn{2}{l}{\textbf{Fourierkoeffizienten}}                                                                                                                         \\ \hline
...
$g(x)$ oder $f(x)$ könnten auch konstante Zahlen sein ($a_0 \in \mathbb{R}, \, a_n = b_n = 0$)
...
\textrightarrow\ Fourier-Reihe approximiert eine Funktion am Besten! \smallskip
...
$$ \lim \limits_{m \to \infty} \left\|\sum\limits _{n=1}^m \big[ a_n \cdot \cos(n \, \omega_f \, t) + b_n \cdot \sin(n \, \omega_f \, t) \big] - f(t) \right\| = 0 $$
...
Die Fourierkoeffizienten bilden Nullfolgen (Konsequenz: Konvergenz)
