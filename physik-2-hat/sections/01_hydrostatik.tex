...
\textbf{Diese Formel kann auch von einem Bezugspunkt ungleich $0 \meter$ aus verwendet werden.}

Verwenden Sie jedoch die Drücke für die spezifische $\cor{h_0}$ und $\cor{h_{\rm rel}}$.
...
Im Falle des Schwimmens gilt $m_{\text{verdrängt}} = m_{\text{Körper}}$, jeder Art von Fluid: $V_{\text{verdrängt}} \cdot \rho_{\text{Fl}} = m_{\text{Körper}}$
...
\textbf{Die Surfaceforce} $\sigma$ wirkt entlang der \textbf{Kontaktlinie} zwischen Flüssigkeit und Festkörper.
