...
$$ \boxed{ \frac{\Delta V}{\Delta t} = \dot{V} = Q = A \cdot v = \const  \quad \Leftrightarrow \quad  A_1 \cdot v_1 = A_2 \cdot v_2 = \frac{\Delta V}{\Delta t} = \dot{V}} $$ 
...
\begin{tabular}{c l c}
	...
	$v_x$ 		& Geschwindigkeit der Flüssigkeit (Durchflussgeschwindigkeit) 	& $[v_x] = \frac{\meter}{\second}$			\\
	$Q$			& Volumenstrom (Volumen pro Zeit)	& $[Q] = \frac{\meter^3}{\second}$
\end{tabular}
