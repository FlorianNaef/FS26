...
\begin{tabular}{c l c}
    ...
    $v$           
                          & Geschwindigkeitsdifferenz zw. Auflagen    & $[v] = \frac{\meter}{\second}$                    \\
    $z$                         & Richtung senkrecht zur Verschiebung       & $[z] = \meter$                              
      \\
    $d$                         & Distand zwischen den Auflagen             & $[d] = \meter$                                    \\
    $\frac{\diff v}{\diff z}$   
& Geschwindigkeits-Gradient in z-Richtung   & $[\frac{\diff v}{\diff z}] = \frac{1}{\second}$ 
\end{tabular}
...
\begin{minipage}[c]{0.68\columnwidth}
    ...
    \begin{tabular}{c l c}
        ...
        $\rho$  & Dichte          
                  & $[\rho] = \frac{\kilogram}{\meter^3}$ \\	
    \end{tabular}
    \renewcommand{\arraystretch}{1.5}
\end{minipage}\vspace{1em}

\textit{Wird die Viskositätsart nicht spezifiziert, ist es die kinematische.}
...
$r$                                 & betrachteter Radius                   & $[r] = \meter$                            \\
    $\eta$           
                               & Dynamische Zähigkeit (Viskosität)     & $[\eta] = \pascal \cdot \second = \frac{\kilogram}{\meter \cdot \second}$             \\
    $R$                                 & Rohr-(Innen)Radius             
       & $[R] = \meter$                            \\
...
Die Reynoldszahl ist ein Richtmass für die Wirbelbildung. \smallskip
\begin{itemize}
...
\begin{tabular}{c l c}
    ...
    $\eta$          & Dynamische Zähigkeit (Viskosität)     
& $[\eta] = \pascal \, \second$             \\
...
\begin{minipage}[t]{0.58\columnwidth}
    ...
    (z.B. ein Flugzeugflügel) \textbf{Null} ist. \medskip
...
\begin{ctabular}{c| c |c}
                                    & laminar                                                   & turbulent          
                                        \\ 
    \hline 
    \cbl{Korrekturfaktoren}               & $\alpha_1 = \alpha_2 = 2$                               
  & $\alpha_1 \approx \alpha_2 \approx 1$                     \\ 
    \hline 
...
Das $v$ im Term $\Delta p_v$ und $\frac{1}{2}\alpha_n \cdot \dots$ sind \textbf{gleich}
...
\begin{tabular}{c l c}
    $F_A$       & Dynamischer Auftrieb                              & $[F_A] = \newton$                     \\
    $c_A$       & Auftriebskoeffizient (Form + Winkel)                  & $[c_A] = 1$                           \\
    $\rho$      & Luft-Dichte                                      
  & $[\rho] = \frac{\kilogram}{\meter^3}$ \\
...
\subsection[Induzierter Widerstand]{Aerodynamischer (Ind.) Widerstand $\bm{F_W}$}
...
\begin{minipage}{0.60\columnwidth}
    ...
    \begin{tabular}{c l c}
        ...
        $c^*_W$     & Widerstands-Koeffizient    
        & $[c^*_W] = 1$                     \\
        $c_A$       & Auftriebs-Koeffizient         & $[c_A] = 1$                       \\
        $v_V$       & Vertikal-Geschwindigkeit      
& $[v_V] = \frac{\meter}{\second}$  \\
