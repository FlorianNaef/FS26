...
\begin{tabular}{c l c}
		...
		$\gamma$ 
 		& Volumenausdehnungskoeffizient & $[\beta] = \frac{1}{\kelvin}$ \\ 
		$\Delta \, T$ 	& Temperaturänderung 			& $[\Delta \, T ] = \kelvin$
\end{tabular}\medskip

\textbf{Achtung:} $\beta = 2\alpha \quad \gamma = 3\alpha$ gilt nur für \textbf{feste} Materialien
...
\begin{tabular}{c l c}
	...
	$\alpha$ 		& Längenausdehnungskoeffizient 	& $[\alpha] = \frac{1}{\kelvin}$ 	\\ 
	$\Delta \, T $ 	& Temperaturänderung 			& $[\Delta \, T ] = \kelvin$ 		\\
	$\Delta l$		& Verhinderte Dehnung			& $[\Delta k] = \meter$				\\
	$p$ 			& Druck 						& $[p] = \pascal$
\end{tabular}\medbreak

\cor{$T_0$ beginnt dort, wo die Materialien sich berühren (Freiraum = 0)}
