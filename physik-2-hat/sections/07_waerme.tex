...
\begin{tabular}{c l c}
	$\Delta U$ 	& Zu-/Abgeführte Innere Energie \textbf{in system} (normalerweise $=0$)															& $[\Delta U] = \joule$ \\
...
\hfill
\begin{minipage}[t]{0.48\columnwidth}
	Beim Schmelzen und Verdampfen findet \textbf{keine} Temperaturerhöhung statt. \medskip
...
\begin{tabular}{c l c@{}}
	...
	\crd{ACHT.}			& \crd{Mit $\Delta T = T_{fin} - T_{in}$ verwende immer $+ \Delta Q$}&\\
	Falls				& $\Delta T = \abs{T_{fin} - T_{in}}$							&\\
	$\bullet$			& $+$:  Zugeführte Wärme-Menge  (Aufgenommene Wärme)								&\\
	$\bullet$			& $-$: Abgeführterr Wärme-Menge	(Abgegebene Wärme)					&
