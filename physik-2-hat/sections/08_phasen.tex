...
\begin{itemize}
	...
	\item oltre la temperatura critica \textbf{$T_k$ il gas non è più liquido} (Hg a temperatura ambiente)	\item Bei Kompression oder Expansion ändert sich der Dampfdruck nicht, sondern der Anteil Flüssigkeit zu Gas muss ändern
\end{itemize}
...
\begin{itemize}
	...
	\item Le linee tratteggiate mostrano l'equazione di Van der Waals (errore nel modello matematico)\end{itemize}
...
Temperatura alla quale si ha un'umidità dell'aria del 100\%. \smallskip
